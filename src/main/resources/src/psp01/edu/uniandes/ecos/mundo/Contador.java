...
public class Contador {
     ...
     */
    public void contadorClases(String url, String[] directorios, HttpServletResponse resp) {
        ...
        for (String directorio1 : directorios) {
            ...
            if (archivoLectura.isDirectory()) {
                ...
                contadorClases(archivoLectura.getPath(), archivoLectura.list(), resp);
            } else {
                cantidadClases++;
                contadorLineas(archivoLectura, url, resp);
            }
     ...
     */
    public void contadorLineas(File archivo, String url, HttpServletResponse resp) {
        ...
        try {
            try {
                ...
                if (resp != null) {
                    resp.getWriter().println("<b>********    " + archivo.getName() + "   **************</b>" + "<br>");
                    resp.getWriter().println("<b> Estoy en el directorio: " + archivo.getParent() + "</b>" + "<br>");
                    resp.getWriter().println("<b> Cantidad de Lineas : " + contador + "</b>" + "<br>");
                } else {
                    System.out.println("\n" + "********    " + archivo.getName() + "   **************" + "\n");
